...
rad_ball.goto(random.randint(-290, 290), 290)
rad_ball.dy = -0.12
...
green_ball.goto(-290, random.randint(-290, 290))
...
pink_ball.goto(290, random.randint(-290, 290))
pink_ball.dy = -0.12
...
track_ball.goto(random.randint(-290, 290), -290)
track_ball.dy = -0.12
# 定義小龜上下左右移的函數
def move_left():
